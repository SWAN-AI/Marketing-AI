...
# v2 is the code with transformers model
...
class MultimodalBertEncoder(nn.Module):
    def __init__(self, args):
        ...
        roberta = RobertaModel.from_pretrained('roberta-base', config=model_config, ignore_mismatched_sizes=True)
        roberta.embeddings.token_type_embeddings = torch.nn.Embedding(2, model_config.hidden_size)
        roberta.embeddings.token_type_embeddings.weight.data.normal_(mean=0.0, std=model_config.initializer_range)
